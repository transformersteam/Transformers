...
namespace DongXu.Target.IRepository.IProgressQuery
{
    public interface IWeekQueryRepository
    {
        ...
        /// <returns></returns>
        PageData<WeekData> GetWeekList(int pageIndex, int pageSize, string goalName, int typeId, int leaveId, int stateId, string dutyCommanyName, string dutyUserName, DateTime goaltime);
    }
}
